...
//        EditText passwordEdt=(EditText)findViewById(R.id.passwordInput);
        ...
        signupBtn.setOnClickListener(new View.OnClickListener() {               //SIGNUP 버튼 클릭 이벤트
            ...
            public void onClick(View view) {
                ...
                boolean flag;
                //=Pattern.matches("^[0-9]*$", email);
                //Toast.makeText(Signup.this,"E-MAIL: " + email.toString() + "   " + "ID: " + id.toString(),Toast.LENGTH_LONG).show();
                /*if (flag){
                    Toast.makeText(Signup.this, "true", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(Signup.this, "false", Toast.LENGTH_SHORT).show();
                }                  //   불린함수테스트*/
                ...
                editor.commit();
                Toast.makeText(Signup.this,"회원님, 반갑습니다.",Toast.LENGTH_LONG).show();
